...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        locationCallback = object : LocationCallback() {
            override fun onLocationResult(locationResult: LocationResult) {
                ...
                Log.d("MapsActivity", "New location update: $location")
    ...
    private fun getLastLocation() {
        // This function is no longer the primary way to get location.
    }
    ...
    private fun startLocationUpdates() {
        ...
        try {
            ...
            Log.e("MapsActivity", "Security Exception when requesting updates: ${e.message}")
        }
    }
    ...
    private fun showPermissionRationale(positiveAction: () -> Unit) {
        AlertDialog.Builder(this)
            ...
            .setMessage("This app needs your location to function.")
...
//                        Log.d("MapsActivity", "Got location: $location")
//                        location?.let {
